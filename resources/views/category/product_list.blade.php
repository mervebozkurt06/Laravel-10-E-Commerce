            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Category : <b>{{ $category->name }} </b> Products</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><b>{{ $category->name }} </b> Products</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered first">
                                    ...
                                    @foreach ($datalist as $product)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('product_destroy',$product->id) }}"
                                                      method="POST">
                                                    @csrf
